...
void AddCamera::execute(std::shared_ptr<Facade> &facade) {
...
void RemoveCamera::execute(std::shared_ptr<Facade> &facade) {
...
void MoveCamera::execute(std::shared_ptr<Facade> &facade) {
